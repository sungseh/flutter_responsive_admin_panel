...
/// * AppShimmer effect only affects to opaque areas of [child], transparent areas
...
///
/// * use one [AppShimmer] to wrap list of [Widget]s instead of a list of many [AppShimmer]s
///
@immutable
class AppShimmer extends StatefulWidget {
  ...
  /// [AppShimmer] which [gradient] is [LinearGradient] made up of `baseColor` and
  /// `highlightColor`.
  ///
